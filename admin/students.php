									 ...
									 <?php
										...
										if(isset($_GET['roll_no']) && !empty($_GET['roll_no'])){
											$roll_no = $_GET['roll_no'];
											 ...
											 $query = "SELECT * FROM `students` where `rollno` LIKE '%".$roll_no."%' LIMIT 20 OFFSET ".$current_page*20;
											 $query2 = "SELECT * FROM `students` where `rollno` LIKE '%".$roll_no."%' ";
										}else if(isset($_GET['name1']) && !empty($_GET['name1'])){
											$name = $_GET['name1'];
											 $to_add_in_link  = '?name='.$name.'&&';
											 $query = "SELECT * FROM `students` where `name` LIKE '%".$name."%' LIMIT 20 OFFSET ".$current_page*20;
											 $query2 = "SELECT * FROM `students` where `name` LIKE '%".$name."%'";
										}else if(isset($_GET['class']) && !empty($_GET['class'])){
											$class = $_GET['class'];
											 $to_add_in_link  = '?class='.$class.'&&';
											 $query = "SELECT * FROM `students` where `UG` LIKE '%".$class."%' LIMIT 20 OFFSET ".$current_page*20;
											 $query2 = "SELECT * FROM `students` where `UG` LIKE '%".$class."%'";
										} else if(isset($_GET['dept']) && !empty($_GET['dept'])){
											$dept = $_GET['dept'];
											 $to_add_in_link  = '?dept='.$dept.'&&';
											 $query = "SELECT * FROM `students` where `UGspecialization` LIKE '%".$dept."%' LIMIT 20 OFFSET ".$current_page*20;
											 $query2 = "SELECT * FROM `students` where `UGspecialization` LIKE '%".$dept."%'";
										}else if(isset($_GET['mail_id']) && !empty($_GET['mail_id'])){
											$mail_id = $_GET['mail_id'];
											 $to_add_in_link  = '?mail_id='.$mail_id.'&&';
											 $query = "SELECT * FROM `students` where `email` LIKE '%".$mail_id."%' LIMIT 20 OFFSET ".$current_page*20;
											 $query2 = "SELECT * FROM `students` where `email` LIKE '%".$mail_id."%'";
										}else if(isset($_GET['mobile_no']) && !empty($_GET['mobile_no'])){
											$mobile_no = $_GET['mobile_no'];
											 $to_add_in_link  = '?mobile_no='.$mobile_no.'&&';
											 $query = "SELECT * FROM `students` where `mobile` LIKE '%".$mobile_no."%' LIMIT 20 OFFSET ".$current_page*20;
											 $query2 = "SELECT * FROM `students` where `mobile` LIKE '%".$mobile_no."%'";
										}else if(isset($_GET['cgpa']) && !empty($_GET['cgpa'])){
											$cgpa = $_GET['cgpa'];
											 $to_add_in_link  = '?cgpa='.$cgpa.'&&';
											 $query = "SELECT * FROM `students` where `aggregateUG` > ".$cgpa." ORDER BY  `aggregateUG` DESC LIMIT 20 OFFSET ".$current_page*20;
											 $query2 = "SELECT * FROM `students` where `aggregateUG` > ".$cgpa;
										} else {
											 $to_add_in_link  = '?';
											 $query = "SELECT * FROM `students` LIMIT 20 OFFSET ".$current_page*20;
